    ...
    public static async Task ApplyMigrationsAsync(string connectionString, CancellationToken ct = default)
    {
        ...
        const string sql = @"
            ...
            VALUES 
                ...
                ('f5555555-5555-5555-5555-555555555555', '11111111-1111-1111-1111-111111111111', 'EMPLOYEE', 'Standard Employee', 'موظف عادي', 'Self-service for leave, attendance, and profile view.', '[""self.leave.request"", ""self.leave.cancel"", ""self.attendance.checkin"", ""self.profile.read""]'::jsonb, TRUE, 1)
